...
class _HeroPageState extends State<HeroPage> with TickerProviderStateMixin {
  final List<Game> _games = [
    Game('本周新游推荐', '编辑最爱', '点击了解这款游戏', 'img/Zelda.png', """游戏简介
...
观看颠峰对决视频，学习顶级玩家的各种对战策略。"""),
    Game('本周战争游戏推荐', '重磅更新', '点击了解这款游戏', 'img/game3.jpg',
    ...
    Game('蜘蛛侠 屌的一批', '编辑喜欢玩', '全新资料片', 'img/game2.png',
...
• 聊天交友，探讨策略"""),
    Game('今日APP', '重磅推荐', '点击了解这个APP', 'img/game1.jpg', """中文名称：《功夫世界》
